...
# set title "Pass through one switch"
# Plotting
plot \
"Schedulability_p150.dat" using 2:xtic(1) with histogram title "one switch", \
"Schedulability_p150.dat" using 3:xtic(1) with histogram title "two switches" \